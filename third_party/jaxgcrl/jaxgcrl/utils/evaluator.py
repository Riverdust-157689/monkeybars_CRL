            ...
            metrics.update(
                {
                    ...
                    for name in [
                        ...
                        # brachiation-specific; skipped automatically when absent
                        "max_bar",
                        "dwell_success",
                        "hand_switches",
                        "forward",
                        ...
                        "bar_R",
                        "fell",
                        # M3.1 coverage / true-extrema diagnostics (see the env's
                        # _coverage docstring: these SUM to interpretable quantities)
                        "cov_cross_b1_050",
                        "cov_cross_b1_030",
                        "cov_cross_b1_020",
                        "cov_cross_b1_010",
                        "cov_min_d_b1_improve",
                        "cov_swing_improve",
                        "cov_fwd_improve",
                        "cov_speed_improve",
                        "cov_hand_on_steps",
                        "cov_both_on_steps",
                        "cov_both_runmax_improve",
                        "cov_b1_runmax_improve",
                        "cov_xfer_runmax_improve",
